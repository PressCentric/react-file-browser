...
const FontAwesomeIcons = (majorVersion = 4) => {
  return {
    ...
    Video: <Icon name={'file video'} />,
    Audio: <Icon name={'file audio'} />,
    Archive: <Icon name={'file'} />,
    Word: <Icon name={'file word'} />,
    Excel: <Icon name={'file excel'} />,
    PowerPoint: <Icon name={'file powerpoint'} />,
    Text: <Icon name={'file text'} />,
    PDF: <Icon name={'file pdf'} />,
    Rename: <Icon name={'edit'} />,
